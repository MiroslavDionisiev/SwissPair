export function PlayerField(props: {playerName: string, white: boolean}){
    const imgSrc: string = props.white? "/whitecrown.svg" : "/blackcrown.svg"
    const imgAlt: string = props.white? "White Pieces" : "Black Pieces"
    return (
        <div 
            className="border border-black bg-white flex items-center w-[320px] h-[72px] pt-[24px] pr-[16px] pb-[24px] pl-[32px] gap-[16px]"
            >
